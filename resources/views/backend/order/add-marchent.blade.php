...
<section class="banner_part">
    ...
    <div class="row" style="margin-top: 50px">
            <div class="col-md-6" style="background-color: #6FF08F">
                ...
                <form method="POST" action="https://sacourierservice.com/register">
                    <input type="hidden" name="_token" value="qP0JYbUf7Ourspk9gTYcApTTTz9rji5Wk2sdcW4Y">                        <div class="form-group row">
                        <div class="col-md-12">
                            <input id="cname" type="text" class="form-control" name="cname" value="" placeholder="Enter your business Name" required autofocus>
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row">
                        <div class="col-md-12">
                            <input id="phone" type="text" class="form-control" name="phone" value="" placeholder="Enter Phone" required autofocus>
