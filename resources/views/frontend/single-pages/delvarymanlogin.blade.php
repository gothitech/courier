...
<div class="container" style="padding: 100px">
        <h1  style="background: ;text-align: center; "> Delivery Man Login</h1>
        <div class="row" style="margin-top: 50px">
            <div class="col-md-6" style="background-color: #E0581E ">
                <img  src="">
            </div>
            <div class="col-md-6" style="padding-left: 100px" >
                            <form method="POST" action="https://sacourierservice.com/runner/authenticate">
                                ...
                                <div class="row">
                                    <div class="col pr-2">
                                        <button  type="submit" class="btn btn-block text-uppercase h4 font-weight-bold" style="background: #E0581E; color:#fff;">Login</button>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
